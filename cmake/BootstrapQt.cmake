...
function(gcs_require_qt_module_configs qt_root)
    set(_required_modules Widgets LinguistTools)
    if(DEFINED GCS_GSTREAMER_MODE)
        string(TOUPPER "${GCS_GSTREAMER_MODE}" _qt_gstreamer_mode)
        if(NOT _qt_gstreamer_mode STREQUAL "OFF")
            list(APPEND _required_modules Multimedia MultimediaWidgets)
        endif()
    endif()
